            ...
            <div class="container col-6">
                <div class="row-fluid">
                    <div >
                        ...
                        <table id="tabla">
                            <thead>
                                <th><strong>Permiso <%=permiso.getId_permiso() %></strong></th>
                                <th><%=permisoTipoDAO.read(permiso.getTipo()).getTipo()%></th>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td>Observación:</td>
                                    <td>
                                    <% if(permiso.getObservacion() == "" || permiso.getObservacion() == null ){%>
                                        -
                                    <%}else{%>
                                        <%=permiso.getObservacion() %>
                                    <%}%>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <form action="VerResolucion" method="POST">
                                        <td>
                                            ...
                                            <button class="btn btn-link" type="submit" name="id_resolucion" value="<%=permiso.getResolucion()%>"><i class="fas fa-external-link-alt"></i> <%=permiso.getResolucion()%></button>
                                            <%}%>
                                        </td>
                                    </form>
                                </tr>
