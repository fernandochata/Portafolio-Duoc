                                    ...
                                    <table id="tabla-permisos" class="table table-hover dataTable no-footer">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=Fechas.formatoFecha(permiso.getFecha_creacion()) %></td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <form action="VerResolucion" method="POST">
                                                    <td><button value="<%=permiso.getResolucion()%>" type="submit" name="id_resolucion" class="btn btn-link btn-sm"><i class="fas fa-external-link-alt"></i> Decreto <%=permiso.getResolucion()%></button></td>
                                                </form>
                                            </tr>
                                            <%}%>
                                        </tbody>
